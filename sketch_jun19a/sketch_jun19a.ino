...
void handleRoot() {
  ...
  snprintf(htmlResponse, 3000,
    "<html lang='en'>     <head>         <meta charset='utf-8'>         <meta name='viewport' content='width=device-width, initial-scale=1'>     </head>     <body>               <h1>Time</h1>               <input type='text' name='date_hh' id='date_hh' size=2 autofocus> hh                <input type='text' name='date_mm' id='date_mm' size=2 autofocus> mm                <input type='text' name='date_ss' id='date_ss' size=2 autofocus> ss                <div>                 <br>       <button id='save_button'>Save</button>                 </div>             <script type='text/javascript' src='http://code.jquery.com/jquery-1.7.1.min.js'></script>         <script src='https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js'></script>             <script type='text/javascript' >               var hh;                var mm;                var ss;                $('#save_button').click(function(e) {              console.log('teste', e);                e.preventDefault();                    hh = $('#date_hh').val();                    mm = $('#date_mm').val();                    ss = $('#date_ss').val();                    $.get('/save?hh=' + hh + '&mm=' + mm + '&ss=' + ss, function(data){                      console.log(data);                   });                });              </script>          </body>      </html>  "); 
